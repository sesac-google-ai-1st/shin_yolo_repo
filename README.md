...
![Alt text](eda_val.png)

- 각 지점별 train의 차량 분포는 아래와 같습니다.  
![Alt text](eda_train.png)
...
![Alt text](eda_branch.png)

## 그 외 커스텀 함수들을 만들어서 EDA에 필요한 내용들을 확인 하였습니다.
![Alt text](eda_custom_fn.png)
...
![Alt text](table_nano.png)  
![Alt text](results_nano.png)  
...
![Alt text](table_medium2.png)
- 위 mAP 결과와 동일하나 실제 테스트스 버스 트럭의 검출이 잘됨!!
![Alt text](results_medium2.png)  
...
![Alt text](table_large.png)
- m 모델보다 predict 시간이 좀더 걸리나, 저녁 CCTV 테스트시 검출이 잘됨
![Alt text](results_large.png)  
